...
const badgeTemplate2 = (rowData, { rowIndex }) => <Badge value={Number(rowData.quantity)}  />
...
<Column field="quantity" header="Quantity" body={badgeTemplate2} filter={selectedFilterFields.includes("quantity")} hidden={selectedHideFields?.includes("quantity")}  sortable style={{ minWidth: "8rem" }} />
